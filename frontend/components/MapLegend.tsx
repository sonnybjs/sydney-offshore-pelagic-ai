export function MapLegend() {
  return (
    <div className="absolute left-[14px] bottom-[14px] z-[8] flex flex-wrap gap-2.5 p-2.5 border border-[rgba(255,255,255,0.16)] bg-[var(--overlay-glass)] rounded-[7px] text-[#d8edf7] text-[12px] pointer-events-none">
